            ...
            <Link href={s.link} className="relative cursor-pointer">
              <div className="absolute z-50 flex gap-5 xl:gap-0 flex-col xl:flex-row justify-between items-start xl:items-end left-5 xl:left-20 right-5 xl:right-20 bottom-5 xl:bottom-[84px]">
                ...
                <div className="hidden xl:flex flex-col lg:flex-row gap-5">
                  <button className="bg-[#db0b0b] hover:bg-[#a83838] text-white px-14 py-5 font-bold">DETALJNIJE</button>
                  <button className="bg-[#db0b0b] hover:bg-[#a83838] text-white px-14 py-5 font-bold">TREJLER</button>
                </div>
              </div>
