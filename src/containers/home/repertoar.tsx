...
function RepertoarContainer({ data }: RepertoarProps) {
  return (
    <section className="space-y-10 mt-10 md:mt-20 min-[900px]:mt-28 scroll-m-20" id="repertoar">
      <div className="flex flex-col md:flex-row justify-between px-5 min-[900px]:px-20">
        ...
        <div className="w-full flex flex-col ms-20 mt-1">
          <div className="w-full hidden md:flex flex-row space-x-5 justify-end items-center mb-5">
            <button className="swiper-button-prev-movies rounded-lg">
            ...
            <button className="swiper-button-next-movies rounded-lg">
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
      ...
      <div className="hidden min-[420px]:block px-5 min-[900px]:px-20">
        <Swiper
